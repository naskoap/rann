...
During the experiment, we implemented the available UI features in each of our two external tools. In this section, we summarize what those features are and the pros and cons we found for each based on our use.
